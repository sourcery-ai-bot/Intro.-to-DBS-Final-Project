...
from PyQt6.QtWidgets import QApplication, QMainWindow, QPushButton, QWidget, QGridLayout, QLabel, QLineEdit, \
    QVBoxLayout, QTabWidget, QComboBox, QTableWidget, QTableWidgetItem, QDateEdit, QCheckBox, QHeaderView
...
class HistoricalTab(QWidget):
    ...
    def button_query_click_event(self):
        ...
        print(f'Query executed in {int(time_c.total_seconds() * 1000)} ms')
        self.table.clear()
