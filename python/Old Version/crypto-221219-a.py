...
app_type.add_argument('-cmd', dest='cmd', action='store_true', help='[REQUIRED] NO GUI')
app_type.add_argument('-gui', dest='gui', action='store_true', help='[REQUIRED] GUI')
...
parser.add_argument('-u', type=str, dest='username', help='admin username', default=default_username)
parser.add_argument('-p', type=str, dest='password', help='admin password', default=default_password)
...
class LoginWindow(QWidget):
    def __init__(self, parent, tabs):
        ...
        self.lineEdit_username.setPlaceholderText(f'default username : {username}')
        ...
        self.lineEdit_password.setPlaceholderText(f'default password : {password}')
