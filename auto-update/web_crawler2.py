...
def switch_frame(target_crypto):
    ...
    try:
        ...
        WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH,'/html/body/div[5]/section/div[7]/div[4]/table[1]/tbody/tr[1]/td[1]')) )
        # time.sleep(5)
...
for i in range(20):
    ...
    date=driver.find_element(By.XPATH,'/html/body/div[5]/section/div[7]/div[4]/table[1]/tbody/tr[1]/td[1]')
    tempt.append(date.text)
    price=driver.find_element(By.XPATH,'/html/body/div[5]/section/div[7]/div[4]/table[1]/tbody/tr[1]/td[2]')
    tempt.append(price.text)
    ope=driver.find_element(By.XPATH,'/html/body/div[5]/section/div[7]/div[4]/table[1]/tbody/tr[1]/td[3]')
    tempt.append(ope.text)
    high=driver.find_element(By.XPATH,'/html/body/div[5]/section/div[7]/div[4]/table[1]/tbody/tr[1]/td[4]')
    tempt.append(high.text)
    low=driver.find_element(By.XPATH,'/html/body/div[5]/section/div[7]/div[4]/table[1]/tbody/tr[1]/td[5]')
    tempt.append(low.text)
    vol=driver.find_element(By.XPATH,'/html/body/div[5]/section/div[7]/div[4]/table[1]/tbody/tr[1]/td[6]')
    tempt.append(vol.text)
    change=driver.find_element(By.XPATH,'/html/body/div[5]/section/div[7]/div[4]/table[1]/tbody/tr[1]/td[7]')
